        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" name="first_name" id="first_name" value="" placeholder="نام ">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              <label for="">اشتراک کاربر (روز)</label>
              <input required type="number" class="form-control " name="days" id="days" value="">
        ...
        <table id="example1" class="table table-striped table-bordered">
          ...
          <tbody class="tbody">
            ...
            <tr>
              ...
              <td>
                @if ($user->avatar !== '' &&
                $user->avatar !== null ) <img width="75px" class="img-fluid " src="
                      {{asset("uploads/brokers/$user->avatar")}} " />
                @else <img width="75px" class="img-fluid " src="
                      {{asset("assets/images/avatar.png")}} " /> @endif
              </td>
              <td>
                <a href="{{route('Panel.EditUser',$user)}}" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
