...
<div class="side-menu">
    <div class="side-menu-body">
        <ul>
            ...
            <li><a href="<?php echo e(route('Panel.SeriesList')); ?>"><i class="fas fa-video"></i> <span class="pr-4">سریال</span>
                </a>
            </li>
            <li><a href="<?php echo e(route('Panel.SeriesList')); ?>?type=documentary"><i class="fas fa-video"></i> <span
            ...
            <li><a href="#"><i class="fas fa-image"></i> <span class="pr-4">بنر تبلیغاتی</span> </a>
                <ul>
                    <li><a href="<?php echo e(route('Panel.AddAdvert')); ?>">افزودن</a></li>
                    <li><a href="<?php echo e(route('Panel.AdvertList')); ?>">لیست</a></li>
                </ul>
            </li>
            <li><a href="<?php echo e(route('Panel.SliderList')); ?>"><i class="fas fa-sliders-h"></i> <span
                        class="pr-4">اسلایدشو</span> </a>
            <li><a href="<?php echo e(route('Panel.CatList')); ?>"><i class="fas fa-list-alt"></i> <span class="pr-4">دسته بندی
                        ها</span> </a>
            <li><a href="<?php echo e(route('Panel.CollectionList')); ?>"><i class="fas fa-th"></i> <span class="pr-4">کالکشن ها</span> </a>

            <li><a href="<?php echo e(route('Panel.ActorsList')); ?>"><i class="fas fa-list-alt"></i> <span
            ...
            <li><a href="<?php echo e(route('Panel.Setting')); ?>"><i class="fas fa-cog"></i> <span class="pr-4">تنظیمات</span> </a>
            </li>

        </ul>
    </div>
</div>
<!-- end::side menu --><?php /**PATH C:\xampp1\htdocs\sione\resources\views/Includes/Panel/side-menu.blade.php ENDPATH**/ ?>