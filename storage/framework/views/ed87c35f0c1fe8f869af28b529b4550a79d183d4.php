                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-12">
                                <h3>
                                    ...
                                    <a href="#" class="section-download" data-episode="<?php echo e($section->id); ?>"
                                        data-id="<?php echo e($post->id); ?>" onclick="call(event)">
                                        <i class="fa fa-cloud-download-alt"></i>
                                    </a>
                                </h3>
                                <h4>
                                    <?php echo e($post->duration); ?>  دقیقه
                                </h4>
                            </div>
                            <div class="col-12">
                                <h5>
...
<?php echo $__env->make('Layout.Front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\sione\resources\views/Front/ShowMovie.blade.php ENDPATH**/ ?>